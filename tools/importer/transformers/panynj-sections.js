...
/**
 * Transformer: panynj section breaks and section metadata.
 * Sections and selectors come from tools/importer/page-templates.json (DOM-verified
 * during page analysis). Breaks are inserted in beforeTransform while every section
 * element still exists; Section Metadata is anchored to a marker <hr> in afterTransform.
 */
